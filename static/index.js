...
(function(w) {
    ...
    function shareText(score) {
        ...
        if (score <= 49) return '你就是主播本人？';
        if (score <= 99) return '我奶奶点的都比你快';
        if (score <= 149) return '配总闪亮登场！';
        if (score <= 199) return '什么逆天手速';
        return '无无无无无无无敌';
    }
    ...
    function initSetting() {
        ...
        document.getElementsByTagName("title")[0].innerText = cookie("title") ? cookie("title") : "吃掉小安酱";
        if (cookie("keyboard")) {
